            ...
            <div id="content-wrapper">
                ...
                {(content === 'aki-tyson' || params === 'aki-tyson') &&
                    <>
                        ...
                        <a class="nav-button project-link" href="https://creative.akitechnologies.net/preview/a8ae4fd1#overrides.deviceInfo.deviceType=Phone&ruleBasedFeedRadio%5Be07be279%5D=actual&placementWidth=390&placementHeight=auto" target="_blank" rel="noopener noreferrer">View Demo</a>
                        <p className="content-target" id="aki-tyson-description">A major poultry brand wanted to achieve two aims: highlight a wide range of fresh and frozen product offerings across their core and sub-brands, and better infuse their brand identity among sports fans. My creative solution took these goals head-on, implementing a roulette of recipes to showcase these product offerings, alongside dynamically-targeted color schemes for each unit, matching the color palette to a given local NFL team based upon a user’s location. This resulted in a high number of overall permutations of the creative - especially when three different size formats were taken into account - all of which were smoothly implemented thanks to dynamic handling of all elements at play, with special attention paid to Celtra’s Data Feed functionality.</p>
                    </>
                }
                {(content === 'aki-pebbles' || params === 'aki-pebbles') &&
                    <>
                        ...
                        <a class="nav-button project-link" href="https://creative.akitechnologies.net/preview/47cb3ee0#overrides.deviceInfo.deviceType=Phone&placementWidth=390&placementHeight=auto" target="_blank" rel="noopener noreferrer">View Demo</a>
                ...
                {(content === 'aki-takeRoot' || params === 'aki-takeRoot') &&
                    <>
                        ...
                        <a class="nav-button project-link" href="https://creative.akitechnologies.net/preview/9d764838#overrides.deviceInfo.deviceType=Phone&placementWidth=390&placementHeight=auto" target="_blank" rel="noopener noreferrer">View Demo</a>
                ...
                {(content === 'aki-skittles' || params === 'aki-skittles') &&
                    <>
                        ...
                        <a class="nav-button project-link" href="https://creative.akitechnologies.net/preview/ea77a6e9#overrides.deviceInfo.deviceType=Phone&placementWidth=390&placementHeight=auto" target="_blank" rel="noopener noreferrer">View Demo</a>
                ...
                {(content === 'reddit' || params === 'reddit') && 
                    <>
                        ...
                        <a class="nav-button project-link" href="https://re-ddit.netlify.app/" target="_blank" rel="noopener noreferrer">Explore Project</a>
